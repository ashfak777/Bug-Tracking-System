                                ...
                                <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-items-center table-flush">
											...
											$image = 'http://192.168.8.148/Bug_api/uploads/10.jpg';
											$imageData = base64_encode(file_get_contents($image));
											
											?>
														
														<td><?php echo '<img width="180px" height="180px" src="data:image/jpeg;base64,'.$imageData.'"/>'; ?></td>
                                                        <td><span class="badge badge-danger">inprocess</span></td>
                                                        <td><a href="Admin_complaintsupdate.php?id=<?php echo $uid?>">update</a></td>
                                                    </TR>
