                ...
                <div id="content">
                    ...
                    <div class="container-fluid" id="container-wrapper">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Block Users</h1>
                            <ol class="breadcrumb">
                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <div class="card">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Block Users</h6>
                                    </div>
                                    <div class="table-responsive">
                                        ...
                                        <table class="table align-items-center table-flush">
                                            ...
                                            <tbody>
                                                ...
                                                $query = mysqli_query($connection, "SELECT * from user WHERE status='block'");
                                                ...
                                                <TR>
                                                    ...
                                                    <td><a href="Super_adminupdateuser.php?id=<?php echo $uid?>">Update</a></td>
                                                </TR>
